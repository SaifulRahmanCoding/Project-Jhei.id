				...
				foreach ($result as $produk) {
					...
					<div class="col-6 col-sm-4 col-lg-3 mb-3 mb-lg-5">
						<div class="text-center pe-0 ps-0 pe-sm-1 ps-sm-1 pt-4 pb-2">
							...
							<button type="button" class="btn btn-white p-0" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $produk['id_produk']?>">
								<div class="overlay-produk d-flex">
									<a class="detail-overlay text-white text-decoration-none">Detail Produk</a>
								</div>
								<img src="<?php echo $produk['foto']?>" alt="" class="foto-produk-awal"><br>
							</button>
							<?php
							...
							?>
							<h1 class="mt-4">
								<a class='text-decoration-none'><?php echo $jheina?></a><?php echo $jenis_nya?>
							</h1>
							<?php
							$harga_database = $produk['harga'];
							$format_harga = number_format($harga_database,0,",",".");
							?>
							<p class="mb-0" style="font-size: 18px; font-family: system-ui;">Rp <?php echo $format_harga?></p>
							<p class="mt-3 mb-2 pb-0 d-flex justify-content-center">
								<a href="https://wa.me/<?php echo $whatsapp?>?text=Hai%20Kak%2C%20Saya%20pesan%20produk%20<?php echo $produk['nama']?>%20<?php echo $produk['berat']?>%20gr%20sebanyak%20[isi%20mau beli berapa]" class="detail-produk text-decoration-none pe-4 ps-4 pt-1 pb-1">PESAN</a>
							</p>

							<!-- The Modal -->
							<div class="modal fade" id="myModal<?php echo $produk['id_produk']?>">
										...
										<div class="modal-body">
											...
											<div class="row pe-1 ps-1 pe-sm-5 ps-sm-5">
												...
												<div class="col-12 m-auto">
													<img src='<?php echo $produk['foto']?>' class='card-img-top'>
												</div>
												...
												<ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
													...
													<li class="nav-item ms-auto" role="presentation">
														<button class="nav-link active" id="deskripsi-tab" data-bs-toggle="tab" data-bs-target="#deskripsi<?php echo $produk['id_produk']?>" type="button" role="tab" aria-controls="deskripsi" aria-selected="true">Deskripsi</button>
													</li>

													<li class="nav-item me-auto" role="presentation">
														<button class="nav-link" id="ket-produk-tab" data-bs-toggle="tab" data-bs-target="#ket-produk<?php echo $produk['id_produk']?>" type="button" role="tab" aria-controls="ket-produk" aria-selected="false">Ket. Produk</button>
													</li>
												...
												<div class="tab-content mb-3 mb-sm-5" id="myTabContent">
													...
													<div class="tab-pane fade show active" id="deskripsi<?php echo $produk['id_produk']?>" role="tabpanel" aria-labelledby="deskripsi-tab">
														<div class="mt-3 text-start text-justify m-auto">
															<?php echo $produk['caption']?>
														</div>
													</div>

													<div class="tab-pane fade" id="ket-produk<?php echo $produk['id_produk']?>" role="tabpanel" aria-labelledby="ket-produk-tab">
														<div class="ket row mt-3 text-start text-justify text-center">
															<div class="col-4">
																...
																?>
																<p> Harga  </p>
																<span class="fw-bolder pb-5">Rp <?php echo $format_harga?></span>
																
															</div>
															<div class="col-4">
																<p> Berat </p>
																<span class="fw-bolder pb-5"><?php echo $produk['berat']?> gram</span>
															</div>

															<div class="col-4">
																<p> Stok </p>
																<span class="fw-bolder pb-5"><?php echo $produk['stok']?></span>
															</div>
